...
<head>
	...
	<link rel="stylesheet" type="text/css" href="../css/Liens Utiles.css">
...
<body>
	...
	<article>
		...
		<section id="center">
			<table>
				<tr align="center">
					<h3 id="titre">Voila quelques sites d'etablissements public du Japon si vous voulez savoir plus à propos de ce pays</h3>
				</tr>
				<tr>
					<td align="right"><img src="../medias/bn_jnto_fr.gif"></td>
					<td><a href="https://www.jnto.go.jp/" target=”_blank”>Office National du Tourisme Japonais</a></td>
				</tr>
				<tr>
					<td align="right"><img src="../medias/banner_mofa.gif"></td>
					<td><a href="https://www.mofa.go.jp/" target=”_blank”>Ministère des Affaires Etrangères du Japon</a></td>
				</tr>
				<tr>
					<td align="right"><img src="../medias/kantei_en.jpg"></td>
					<td><a href="http://japan.kantei.go.jp/index.php" target=”_blank”>Cabinet du Premier Ministre</a></td>
				</tr>
			</table>
		</section>
